...
{
	[Serializable]
    public class WikiHistory : BusinessBase<WikiHistory, Guid>, IWorkWikiItem
	{
        ...
        public WikiHistory(CodeFactory.Wiki.IWiki item)
            : this(item.ID)
        {
            _item = item;
        }

        public WikiHistory(Guid id)
            : base(id)
        {
        }
        ...
        {
            get { return string.Format("{0}admin/wikiHistory.aspx?trackingNumber={1}", Utils.RelativeWebRoot, 
                this.TrackingNumber); }
        }
        ...
        protected override WikiHistory DataSelect(Guid id)
        {
            return (WikiHistory)WikiService.SelectWikiHistory(id);
        }

        protected override void DataUpdate()
        {
            WikiService.UpdateWikiHistory(this);
        }

        protected override void DataInsert()
        {
            WikiService.InsertWikiHistory(this);
        }

        protected override void DataDelete()
        {
            WikiService.DeleteWikiHistory(this);
        }
