<%@ Page Title="Wiki - Autorizaciones Pendientes" Language="C#" MasterPageFile="~/WikiMaster.master" AutoEventWireup="true" CodeFile="pendingsOfAuthorization.aspx.cs" Inherits="admin_pendingsOfAuthorization" Theme="Default" StyleSheetTheme="Default" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainPlaceHolder" Runat="Server">
    <asp:ScriptManager ID="TheScriptManager" runat="server" 
        ...
        TargetControlID="DateModifiedTextBox" PopupButtonID="ExpirationDateButton">
                </cc1:calendarextender>
    <asp:Label ID="TitleLabel" runat="server" Text="Autorizaciones Pendientes" 
    ...
    <table width="770" style="background-color: #EFEFEF">
        ...
        <tr>
            ...
            <td class="style16">
                &nbsp;</td>
            <td style="text-align: right;" class="style14">Expira el día:</td>
            <td class="style13">
    ...
    <div id="data">
    <asp:GridView ID="TheWorkWikiItemsGridView" runat="server" 
        AutoGenerateColumns="False" DataSourceID="TheWorkWikiItemsSource" 
        AllowPaging="True" onrowdatabound="TheWorkWikiItemsGridView_RowDataBound" 
        Width="770px" BorderStyle="Solid" 
        ondatabound="TheWorkWikiItemsGridView_DataBound">
        <RowStyle VerticalAlign="Top" />
        <Columns>
            <asp:TemplateField HeaderText="Title" SortExpression="Title">
                <ItemTemplate>
                    <asp:HyperLink ID="Label1" runat="server" Text='<%# Bind("Title") %>'
                                         NavigateUrl='<%# Bind("TrackingLink") %>'></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
        ...
        <EmptyDataTemplate>
            No existen autorizaciones pendientes.
        </EmptyDataTemplate>
        <HeaderStyle BackColor="#33CCCC" ForeColor="SteelBlue" />
        <AlternatingRowStyle BackColor="#C9F1F1" />
    </asp:GridView>
    <asp:ObjectDataSource ID="TheWorkWikiItemsSource" runat="server" 
        EnablePaging="True" OldValuesParameterFormatString="original_{0}" 
        onobjectcreating="TheWorkWikiItemsSource_ObjectCreating" 
        SelectCountMethod="TotalCount" SelectMethod="GetResults" 
        TypeName="WorkWikiItemResultSet"></asp:ObjectDataSource>
    </div>
