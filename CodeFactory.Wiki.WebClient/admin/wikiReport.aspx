<%@ Page Title="Wiki - Reporte" Language="C#" MasterPageFile="~/WikiMaster.master" AutoEventWireup="true" CodeFile="wikiReport.aspx.cs" Inherits="admin_wikiReport" StyleSheetTheme="Default" Theme="Default" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="MainPlaceHolder" Runat="Server">
    ...
    <asp:Label ID="TitleLabel" runat="server" Text="Reporte de Wikis" 
    ...
    <div id="data">
    <asp:GridView ID="TheWikiGridView" runat="server" AutoGenerateColumns="False" 
        DataSourceID="TheWikiDataSource" AllowPaging="True" Width="770px" 
        BorderStyle="Solid" ondatabound="TheWikiGridView_DataBound" 
        onrowdatabound="TheWikiGridView_RowDataBound">
        <RowStyle VerticalAlign="Top" />
        <Columns>
            <asp:TemplateField HeaderText="Título" SortExpression="Title">
                <ItemTemplate>
                    <asp:HyperLink ID="WikiLink" Text='<%# Eval("Title") %>' NavigateUrl='<%# Bind("RelativeLink") %>' runat="server"></asp:HyperLink>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:ObjectDataSource ID="TheWikiDataSource" runat="server" 
        OldValuesParameterFormatString="original_{0}" 
        onobjectcreating="TheWikiDataSource_ObjectCreating" EnablePaging="True" 
        SelectCountMethod="TotalCount" SelectMethod="GetResults" 
        TypeName="WikiResult"></asp:ObjectDataSource>
    </div>
