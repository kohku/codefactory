<%@ Page Language="C#" MasterPageFile="~/WikiMaster.master" AutoEventWireup="true"
    CodeFile="Default_Old.aspx.cs" Inherits="_Default_Old" Title="Wiki Portada" StylesheetTheme="Default"
                ...
                <tr>
                    <td id="left">                        
                        ...
                        <p>
                            ...
                            <asp:HyperLink ID="ArticleLink1" runat="server">[Ver contenido]</asp:HyperLink>
                        </p></td>
                <td id="middle">&nbsp;</td>
                <td id="right">
                    <p>
                        <asp:HyperLink ID="TitleLabel2" runat="server" CssClass="titles_blue" 
                        Text="Lorelm ipsum dolor"></asp:HyperLink></p>
                        <p>
                            <asp:Label ID="ContentLabel2" runat="server" Text="Content"></asp:Label>&nbsp;
                            <asp:HyperLink ID="ArticleLink2" runat="server">[Ver contenido]</asp:HyperLink>
                    </p>
                    <uc1:TagCloud ID="TheTagCloud" runat="server" />
                    </td>
                </tr>
            </table></div>
        <div id="bottom">
