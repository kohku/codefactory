...
namespace CodeFactory.ContentManager.WebControls
{
	...
	[Designer(typeof(CodeFactory.ContentManager.WebControls.Design.ContextMenuDesign))]
	...
	public class ContextMenu : WebControl, INamingContainer
	{
		...
		private void EmbedScriptCode()
		{
			...
			string js = ReadResourceString("CodeFactory.ContentManager.WebControls.ContextMenu.js");
